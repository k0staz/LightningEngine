...
void D3D11Viewport::SetSizeX(uint32 InSizeX)
{
	Resize(InSizeX, SizeY, IsFullScreen);
}

void D3D11Viewport::SetSizeY(uint32 InSizeY)
{
	Resize(SizeX, SizeY, IsFullScreen);
}

void D3D11Viewport::SetSizeXY(uint32 InSizeX, uint32 InSizeY)
{
	Resize(InSizeX, InSizeY, IsFullScreen);
}

uint32 D3D11Viewport::GetSizeX() const
{
	return SizeX;
}

uint32 D3D11Viewport::GetSizeY() const
{
	return SizeY;
}
}
